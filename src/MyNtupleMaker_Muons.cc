  ...
  
{
    ...
    produces <std::vector<int> >    ( prefix + "NLostHitsTracker" + suffix );
    produces <std::vector<int> >    ( prefix + "NLostHitsTrackerIn" + suffix );
    produces <std::vector<int> >    ( prefix + "NLostHitsTrackerOut" + suffix );
    produces <std::vector<int> >    ( prefix + "NHitsPixel" + suffix );
    produces <std::vector<int> >    ( prefix + "NLostHitsPixel" + suffix );
    produces <std::vector<int> >    ( prefix + "NHitsMuon" + suffix );
    produces <std::vector<int> >    ( prefix + "NLostHitsMuon" + suffix );
    ...
    produces <std::vector<double> > ( prefix + "RefPtX" + suffix );
    produces <std::vector<double> > ( prefix + "RefPtY" + suffix );
    produces <std::vector<double> > ( prefix + "RefPtZ" + suffix );
...
MyNtupleMaker_Muons::produce(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
    ...
    std::auto_ptr<std::vector<int> >     nLostHitsTracker ( new std::vector<int>()  );
    std::auto_ptr<std::vector<int> >     nLostHitsTrackerIn ( new std::vector<int>()  );
    std::auto_ptr<std::vector<int> >     nLostHitsTrackerOut ( new std::vector<int>()  );
    std::auto_ptr<std::vector<int> >     nHitsPixel ( new std::vector<int>()  );
    std::auto_ptr<std::vector<int> >     nLostHitsPixel ( new std::vector<int>()  );
    std::auto_ptr<std::vector<int> >     nHitsMuon ( new std::vector<int>()  );
    std::auto_ptr<std::vector<int> >     nLostHitsMuon ( new std::vector<int>()  );
    ...
    std::auto_ptr<std::vector<double> >  refPtX   ( new std::vector<double>()  );
    std::auto_ptr<std::vector<double> >  refPtY   ( new std::vector<double>()  );
    std::auto_ptr<std::vector<double> >  refPtZ   ( new std::vector<double>()  );
    ...
    if(muons.isValid())
    {
        ...
        for( std::vector<pat::Muon>::const_iterator it = muons->begin(); it != muons->end(); ++it )
        {
            ...
            nLostHitsTracker->push_back( ( tracker ? it->track()->hitPattern().numberOfLostTrackerHits() : -1 ) );
            nLostHitsTrackerIn->push_back( ( tracker ? it->track()->trackerExpectedHitsInner().numberOfLostTrackerHits() : -1 ) );
            nLostHitsTrackerOut->push_back( ( tracker ? it->track()->trackerExpectedHitsOuter().numberOfLostTrackerHits() : -1 ) );
            nHitsPixel->push_back( ( tracker ? it->track()->hitPattern().numberOfValidPixelHits() : -1 ) );
            nLostHitsPixel->push_back( ( tracker ? it->track()->hitPattern().numberOfLostPixelHits() : -1 ) );
            nHitsMuon->push_back( ( global ? it->globalTrack()->hitPattern().numberOfValidMuonHits() : -1 ) );
            nLostHitsMuon->push_back( ( global ? it->globalTrack()->hitPattern().numberOfLostMuonHits() : -1 ) );
            ...
            refPtX->push_back( it->vertex().x() );
            refPtY->push_back( it->vertex().y() );
            refPtZ->push_back( it->vertex().z() );
    ...
    iEvent.put( nLostHitsTracker, prefix + "NLostHitsTracker" + suffix );
    iEvent.put( nLostHitsTrackerIn, prefix + "NLostHitsTrackerIn" + suffix );
    iEvent.put( nLostHitsTrackerOut, prefix + "NLostHitsTrackerOut" + suffix );
    iEvent.put( nHitsPixel, prefix + "NHitsPixel" + suffix );
    iEvent.put( nLostHitsPixel, prefix + "NLostHitsPixel" + suffix );
    iEvent.put( nHitsMuon, prefix + "NHitsMuon" + suffix );
    iEvent.put( nLostHitsMuon, prefix + "NLostHitsMuon" + suffix );
    ...
    iEvent.put( refPtX, prefix + "RefPtX" + suffix );
    iEvent.put( refPtY, prefix + "RefPtY" + suffix );
    iEvent.put( refPtZ, prefix + "RefPtZ" + suffix );
